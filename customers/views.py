...
from .serializers import CustomerSerializer, CustomerAdminSerializer
...
class CustomerViewSet(viewsets.ModelViewSet):
    ...
    **Ordonner l'attribut 'sales_contact_id' permet de mettre en évidence les clients non affectés à un membre de l'équipe "VENTE"**.\n
    Seuls les "supers-utilisateurs" peuvent affecter une membre de l'équipe "VENTE" à un Client.\n
    ...
    detail_serializer_class = CustomerSerializer
