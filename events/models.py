...
class Event(models.Model):
    ...
    support_contact = models.ForeignKey(User, verbose_name="Membre support assigné",
                                        related_name="assigned_events", on_delete=models.SET_DEFAULT, default=0, blank=True, null=True, limit_choices_to={'group': "SUPPORT"})
    ...
    attendees = models.IntegerField(
        validators=[validators.MinValueValidator(1)], verbose_name="Nombre d'invités")
